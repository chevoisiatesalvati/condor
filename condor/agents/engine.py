...
# Lifecycle locks for start/resume races. The running-engine registry itself
# lives in the supervisor (condor.runtime.loops) — see comment below.
...
class TickEngine:
    ...
    def __post_init__(self):
        ...
        from .strategy_paths import ensure_strategy_data_dir

        strategy_dir = ensure_strategy_data_dir(
            self.agent.slug, self.strategy.slug
        )
